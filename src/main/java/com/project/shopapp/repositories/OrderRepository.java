...
VALUES
    (4, 'John Smith', 'john@example.com', '1234567890', '123 Main St', 'Note 1', 'pending', 500),
    (4, 'Eric Thompson', 'eric@example.com', '9876543210', '456 Elm St', 'Note 2', 'pending', 400),
    (4, 'Hans', 'hans@example.com', '5555555555', '789 Oak St', 'Note 3', 'pending', 300),
    (4, 'Alice Johnson', 'alice@example.com', '5551234567', '789 Cherry Ave', 'Note 4', 'pending', 200),
    (4, 'Robert Williams', 'robert@example.com', '5559876543', '321 Maple Rd', 'Note 5', 'pending', 100),
    (4, 'Sarah Davis', 'sarah@example.com', '5554445555', '987 Elm St', 'Note 6', 'pending', 250),
...
VALUES
    ...
    (5, 1, 10.99, 2, 21.98, 'Red'),
    (6, 2, 5.99, 3, 17.97, 'Blue'),
    (7, 3, 8.49, 1, 8.49, 'Green'),
    (8, 1, 10.99, 2, 21.98, 'Red'),
    (9, 2, 5.99, 3, 17.97, 'Blue'),
    (10, 3, 8.49, 1, 8.49, 'Green'),
